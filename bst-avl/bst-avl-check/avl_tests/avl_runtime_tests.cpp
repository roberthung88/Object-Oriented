...
{
	RuntimeEvaluator runtimeEvaluator("AVLTree::insert() with keys in ascending order", 0, 15, 30, [&](uint64_t numElements, RandomSeed seed)
	{
...
{
	RuntimeEvaluator runtimeEvaluator("AVLTree::insert() with keys in descending order", 0, 15, 30, [&](uint64_t numElements, RandomSeed seed)
	{
		AVLTree<uint64_t, uint64_t> tree;
...
{
	RuntimeEvaluator runtimeEvaluator("AVLTree::insert() with keys in random order", 0, 15, 30, [&](uint64_t numElements, RandomSeed seed)
	{
		AVLTree<uint64_t, uint64_t> tree;
...
{
	RuntimeEvaluator runtimeEvaluator("AVLTree::remove() on min element", 0, 15, 30, [&](uint64_t numElements, RandomSeed seed)
	{
		AVLTree<uint64_t, uint64_t> tree;
...
{
	RuntimeEvaluator runtimeEvaluator("AVLTree::remove() on max element", 0, 15, 30, [&](uint64_t numElements, RandomSeed seed)
	{
		AVLTree<uint64_t, uint64_t> tree;
