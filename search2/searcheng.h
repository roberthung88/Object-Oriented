...
private:
    ...
    std::map<std::string, std::set<std::string>> terms_files; // terms and files that contain                                                         // the terms
    std::map<std::string,PageParser*> parsers; //stores the kind of parser that will be used on                                        //specific types
