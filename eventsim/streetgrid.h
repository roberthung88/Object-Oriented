...
private:
    ...
    size_t calcCrossTime(size_t row, size_t col, bool rowDir);
    ...
    int **rowSeg = new int *[n];
    int **colSeg = new int *[n];
    bool ***blocked = new bool **[n]; //blocked = 1, not blocked = 0; row, col, rowDir
    int **sameTime = new int *[n]; //last vehicle chose row = 1; 2 if col; 0 otherwise
};
